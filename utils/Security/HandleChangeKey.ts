...
import { generateAndStoreKeys } from "../../backend/Encryption/KeyGen";
import { handleAndPublishKeys } from "../../backend/Encryption/HandleKeys";
import { SetStateAction } from "react";

export async function handleChangeKey(walletAddress: string | null, setActionLoading: { (value: SetStateAction<boolean>): void; (arg0: boolean): void; }, setChangeSuccess: { (value: SetStateAction<boolean>): void; (arg0: boolean): void; }, refreshKeyData: { (): Promise<void>; (): any; }) {
    ...
    if (oldRaw) {
      ...
      await AsyncStorage.setItem(`old_private_key_${walletAddress}`, oldKeyPair.privateKey);
    }
